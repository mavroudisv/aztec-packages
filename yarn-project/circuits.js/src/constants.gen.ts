...
export const MERGE_ROLLUP_INDEX = 12;
export const BLOCK_ROOT_ROLLUP_INDEX = 13;
export const BLOCK_MERGE_ROLLUP_INDEX = 14;
export const ROOT_ROLLUP_INDEX = 15;
export const BLOCK_ROOT_ROLLUP_EMPTY_INDEX = 16;
...
export const L2_GAS_PER_NOTE_HASH = 2624;
export const L2_GAS_PER_NULLIFIER = 4224;
export const L2_GAS_PER_PUBLIC_DATA_READ = 1200;
export const L2_GAS_PER_NOTE_HASH_READ_REQUEST = 1200;
export const L2_GAS_PER_NULLIFIER_READ_REQUEST = 2400;
export const L2_GAS_PER_L1_TO_L2_MSG_READ_REQUEST = 1170;
...
export const GAS_SETTINGS_LENGTH = 6;
...
export const TX_CONTEXT_LENGTH = 8;
export const TX_REQUEST_LENGTH = 12;
export const TOTAL_FEES_LENGTH = 1;
export const TOTAL_MANA_USED_LENGTH = 1;
export const HEADER_LENGTH = 25;
export const PRIVATE_CIRCUIT_PUBLIC_INPUTS_LENGTH = 731;
export const PUBLIC_CIRCUIT_PUBLIC_INPUTS_LENGTH = 867;
...
export const COMBINED_ACCUMULATED_DATA_LENGTH = 900;
export const TX_CONSTANT_DATA_LENGTH = 35;
export const COMBINED_CONSTANT_DATA_LENGTH = 44;
export const PRIVATE_ACCUMULATED_DATA_LENGTH = 1412;
export const PRIVATE_KERNEL_CIRCUIT_PUBLIC_INPUTS_LENGTH = 2226;
...
export const AVM_ACCUMULATED_DATA_LENGTH = 318;
export const PRIVATE_TO_PUBLIC_KERNEL_CIRCUIT_PUBLIC_INPUTS_LENGTH = 1845;
export const KERNEL_CIRCUIT_PUBLIC_INPUTS_LENGTH = 956;
...
export const AVM_PROOF_LENGTH_IN_FIELDS = 4161;
...
export const AVM_RETURNDATASIZE_BASE_L2_GAS = 20;
export const AVM_RETURNDATACOPY_BASE_L2_GAS = 29;
...
export const AVM_NOTEHASHEXISTS_BASE_L2_GAS = 1226;
export const AVM_EMITNOTEHASH_BASE_L2_GAS = 2650;
export const AVM_NULLIFIEREXISTS_BASE_L2_GAS = 2426;
export const AVM_EMITNULLIFIER_BASE_L2_GAS = 4250;
export const AVM_L1TOL2MSGEXISTS_BASE_L2_GAS = 1196;
export const AVM_GETCONTRACTINSTANCE_BASE_L2_GAS = 2448;
export const AVM_EMITUNENCRYPTEDLOG_BASE_L2_GAS = 18;
export const AVM_SENDL2TOL1MSG_BASE_L2_GAS = 226;
export const AVM_CALL_BASE_L2_GAS = 4845;
export const AVM_STATICCALL_BASE_L2_GAS = 4845;
export const AVM_RETURN_BASE_L2_GAS = 28;
export const AVM_REVERT_BASE_L2_GAS = 28;
export const AVM_DEBUGLOG_BASE_L2_GAS = 12;
export const AVM_DEBUGLOG_DYN_L2_GAS = 3;
