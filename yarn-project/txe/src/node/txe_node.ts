import { type ContractArtifact, createDebugLogger } from '@aztec/aztec.js';
import {
  type AztecNode,
...
export class TXENode implements AztecNode {
  ...
  #blockNumber: number;
  #logger = createDebugLogger('aztec:txe_node');
   ...
   */
  getBlockHeader(_blockNumber?: L2BlockNumber): Promise<Header> {
