...
export class TXE implements TypedOracle {
  ...
  notifyCreatedNote(storageSlot: Fr, _noteTypeId: NoteSelector, noteItems: Fr[], noteHash: Fr, counter: number) {
    ...
    // console.log('NOTIFYING CREATED NOTE CREATED ADDRESS', this.contractAddress);
  ...
  avmOpcodeEmitUnencryptedLog(_message: any) {
    throw new Error('avmOpcodeEmitUnencryptedLog Unimplemented');
  }
}
